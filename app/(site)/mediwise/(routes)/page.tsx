...
<footer className=" dark:bg-gray-900 w-full">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                  <img src="/images/bhaLogo.png" className="w-20" alt="Mediwise Logo" />
                  <img src="/images/mediwiseLogo.png" className="w-20" alt="Mediwise Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li >
                          <a href="/mediwise/team" className="hover:underline ">Team</a>
                      </li>
                      <li>
                          <a href="#home" className="hover:underline">Our mission</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li >
                          <a href="mediwise/privacy-policy" className="hover:underline">Privacy Policy</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Mediwise™</a>. All Rights Reserved.
          </span>
