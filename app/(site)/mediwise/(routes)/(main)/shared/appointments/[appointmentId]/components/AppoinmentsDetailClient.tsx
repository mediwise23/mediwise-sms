...
const AppoinmentsDetailClient: React.FC<AppoinmentsDetailClientProps> = ({
  ...
  return (
    <div className="flex flex-col bg-white shadow-md p-5 rounded-md">
      <ArrowLeft
        className="w-7 h-7 cursor-pointer rounded-md text-black"
        onClick={() => router.push(`/mediwise/${currentUser.role.toLocaleLowerCase()}`)}
      />
      ...
      <section className="flex flex-col mt-10 w-[50vw] gap-y-5">
        ...
        <div className="flex justify-between ">
            ...
            <Avatar src={appointment?.data?.patient?.image} className="w-[100px] h-[100px]" />
            </div>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <span>
              ...
              >
                {appointment.data?.patient.isVerified ? 'VERIFIED' : 'NOT VERIFIED'}
              </Badge>
            </span>
          </div>
        </div>
      ...
      <section className="flex flex-col mt-10 w-[50vw] gap-y-5">
        ...
        <div className="flex justify-between ">
            <strong>Photo</strong>
            <div className="border rounded-sm p-5">
            <Avatar src={appointment?.data?.doctor?.image} className="w-[100px] h-[100px]" />
            </div>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <span>
              ...
              >
                {appointment.data?.doctor.isVerified ? 'VERIFIED' : 'NOT VERIFIED'}
              </Badge>
            </span>
          </div>
        </div>
